...
// image2base64("https://res.cloudinary.com/dx8lsbkh7/image/upload/v1578588177/t8ydeocvnte5un4ifcqb.jpg") // you can also to use url
//     .then(
//         (response) => {
//             console.log('64',response); //cGF0aC90by9maWxlLmpwZw==
//         }
//     )
//     .catch(
//         (error) => {
...
//     )
    ...
    // const API_KEY = 'Y4ZRsIVo60faVmJ4v7leC87BiZlhE0prBIZdFcywzRGtOZNAgI'
    // axios.post(`https://plant.id/api/identify?${API_KEY}&images=${file}`)
    // .then(() => console.log('hi'))
    // .catch(err => {
    //   console.log('errwithplantid', err)
    // })
  ...
  handleUrl(event){
    ...
    //! works commented out to save on requests
